...
In this exercise, you'll see how to do a breadth first search on a graph. 
...
'''
Implement BFS
Using what you know about BFS for trees and DFS for graphs, let's do BFS for graphs. 
